...
flags.DEFINE_string('pre_train_path', model_dir, 'pretrained model path')
...
def main(_):
    ...
    err = evaluate_heatmap_network(
        model_path=FLAGS.pre_train_path, network_type=FLAGS.network_type, img_path=FLAGS.img_dir,
    ...
    print_nme_statistics(
        errors=err, model_path=FLAGS.pre_train_path, network_type=FLAGS.network_type, test_data=FLAGS.test_data,
