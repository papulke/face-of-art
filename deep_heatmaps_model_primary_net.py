    ...
    def predict_landmarks_in_batches(self, image_paths, session):
        ...
        for j in range(num_batches):
            ...
            batch_pred_landmarks = batch_heat_maps_to_landmarks(
                batch_maps_small_pred, batch_size=batch_size, image_size=self.image_size / 4,
        ...
        if reminder > 0:
            ...
            batch_maps_small_pred = session.run(self.pred_hm_p, {self.images: batch_images})
            batch_pred_landmarks = batch_heat_maps_to_landmarks(
                batch_maps_small_pred, batch_size=reminder, image_size=self.image_size / 4,
                num_landmarks=self.num_landmarks)
        ...
        for j in range(num_batches):
            ...
            if self.allocate_once:
                batch_heat_maps_to_landmarks_alloc_once(
                    ...
                    batch_size=batch_size, image_size=self.image_size / 4, num_landmarks=self.num_landmarks)
            else:
                batch_pred_landmarks = batch_heat_maps_to_landmarks(
                    batch_maps_small_pred, batch_size=batch_size, image_size=self.image_size / 4,
                    num_landmarks=self.num_landmarks)
        ...
        if reminder > 0:
            ...
            if self.allocate_once:
                batch_heat_maps_to_landmarks_alloc_once(
                    ...
                    batch_size=reminder, image_size=self.image_size/4, num_landmarks=self.num_landmarks)
            else:
                batch_pred_landmarks = batch_heat_maps_to_landmarks(
                    batch_maps_small_pred, batch_size=reminder, image_size=self.image_size / 4,
                    num_landmarks=self.num_landmarks)
                    ...
                    if self.compute_nme:
                        ...
                        if self.allocate_once:
                            batch_heat_maps_to_landmarks_alloc_once(
                                ...
                                batch_size=self.batch_size, image_size=self.image_size / 4,
                                num_landmarks=self.num_landmarks)
                        else:
